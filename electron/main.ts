...
import { nianbanUploadService } from './services/nianbanUploadService'
...
function registerIpcHandlers() {
  ...
  ipcMain.handle('export:uploadExportedChatToNianban', async (_, payload) => {
    return nianbanUploadService.uploadExportedChatToNianban(payload)
  })
